...
function useDefaultValue(value) {
  let [defaultValue] = (0, import_react13.useState)(value);
  return defaultValue;
}
...
// src/internal/form-fields.tsx
var FormFieldsContext = (0, import_react15.createContext)(null);
function FormFieldsProvider(props) {
  let [target, setTarget] = (0, import_react15.useState)(null);
  return /* @__PURE__ */ import_react15.default.createElement(FormFieldsContext.Provider, { value: { target } }, props.children, /* @__PURE__ */ import_react15.default.createElement(Hidden, { features: 4 /* Hidden */, ref: setTarget }));
}
function HoistFormFields({ children }) {
  let formFieldsContext = (0, import_react15.useContext)(FormFieldsContext);
  ...
  return target ? (0, import_react_dom.createPortal)(/* @__PURE__ */ import_react15.default.createElement(import_react15.default.Fragment, null, children), target) : null;
}
function FormFields({
  data,
  form: formId,
  ...
  let [form, setForm] = (0, import_react15.useState)(null);
  let d = useDisposables();
  ...
  return /* @__PURE__ */ import_react15.default.createElement(HoistFormFields, null, /* @__PURE__ */ import_react15.default.createElement(FormResolver, { setForm, formId }), objectToFormEntries(data).map(([name, value]) => {
...
function FormResolver({
  ...
  return formId ? null : /* @__PURE__ */ import_react15.default.createElement(
    Hidden,
    {
      features: 4 /* Hidden */,
      as: "input",
...
var IdContext = (0, import_react16.createContext)(void 0);
function useProvidedId() {
  return (0, import_react16.useContext)(IdContext);
}
function IdProvider({ id, children }) {
  return /* @__PURE__ */ import_react16.default.createElement(IdContext.Provider, { value: id }, children);
}
...
function useSyncRefs(...refs) {
  let cache = (0, import_react17.useRef)(refs);
...
function useDescribedBy() {
  var _a2, _b;
  return (_b = (_a2 = (0, import_react18.useContext)(DescriptionContext)) == null ? void 0 : _a2.value) != null ? _b : void 0;
}
  ...
  return [
    ...
    (0, import_react18.useMemo)(() => {
      return function DescriptionProvider(props) {
        ...
        return /* @__PURE__ */ import_react18.default.createElement(DescriptionContext.Provider, { value: contextBag }, props.children);
      };
    }, [setDescriptionIds])
  ];
}
...
var LabelContext = (0, import_react19.createContext)(null);
LabelContext.displayName = "LabelContext";
function useLabelContext() {
  let context = (0, import_react19.useContext)(LabelContext);
  if (context === null) {
...
function useLabelledBy(alwaysAvailableIds) {
  var _a2, _b, _c;
  let labelIds = (_b = (_a2 = (0, import_react19.useContext)(LabelContext)) == null ? void 0 : _a2.value) != null ? _b : void 0;
...
function useLabels({ inherit = false } = {}) {
  ...
  let [labelIds, setLabelIds] = (0, import_react19.useState)([]);
  ...
  return [
    ...
    (0, import_react19.useMemo)(() => {
      return function LabelProvider(props) {
        ...
        return /* @__PURE__ */ import_react19.default.createElement(LabelContext.Provider, { value: contextBag }, props.children);
      };
    }, [setLabelIds])
  ];
}
...
function CheckboxFn(props, ref) {
  ...
  let d = useDisposables();
  let [changing, setChanging] = (0, import_react20.useState)(false);
  let toggle = useEvent(() => {
    setChanging(true);
  ...
  let slot = (0, import_react20.useMemo)(() => {
    return {
      checked,
      disabled,
      hover,
  ...
  let reset = (0, import_react20.useCallback)(() => {
    if (defaultChecked === void 0)
      return;
    return onChange == null ? void 0 : onChange(defaultChecked);
  }, [onChange, defaultChecked]);
  return /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, name != null && /* @__PURE__ */ import_react20.default.createElement(
    FormFields,
    {
      disabled,
      data: { [name]: value || "on" },
...
var CloseContext = (0, import_react21.createContext)(() => {
});
function useClose() {
  return (0, import_react21.useContext)(CloseContext);
}
function CloseProvider({ value, children }) {
  return /* @__PURE__ */ import_react21.default.createElement(CloseContext.Provider, { value }, children);
}

// src/components/close-button/close-button.tsx
function CloseButtonFn(props, ref) {
  let close = useClose();
  return /* @__PURE__ */ import_react22.default.createElement(Button, { ref, ...mergeProps({ onClick: close }, props) });
}
...
function useElementSize(ref, unit = false) {
  ...
  let [identity, forceRerender] = (0, import_react24.useReducer)(() => ({}), {});
  let size2 = (0, import_react24.useMemo)(() => computeSize(element), [element, identity]);
  useIsoMorphicEffect(() => {
    if (!element)
      return;
...
function useOutsideClick(containers, cb, enabled = true) {
  let enabledRef = (0, import_react28.useRef)(false);
  ...
  let initialClickTarget = (0, import_react28.useRef)(null);
  useDocumentEvent(
    "pointerdown",
    (event) => {
      var _a2, _b;
...
function useOwnerDocument(...args) {
  return (0, import_react29.useMemo)(() => getOwnerDocument(...args), [...args]);
}
...
function useRefocusableInput(ref) {
  let info = (0, import_react31.useRef)({
    value: "",
    selectionStart: null,
    selectionEnd: null
  });
...
function useResolveButtonType(props, ref) {
  let [type, setType] = (0, import_react32.useState)(() => resolveType(props));
  useIsoMorphicEffect(() => {
...
function useStore(store) {
  return (0, import_react33.useSyncExternalStore)(store.subscribe, store.getSnapshot, store.getSnapshot);
}
...
function useTrackedPointer() {
  let lastPos = (0, import_react34.useRef)([-1, -1]);
  return {
    wasMoved(evt) {
      if (false) {
        return true;
...
function useTreeWalker({
  ...
  let acceptRef = (0, import_react35.useRef)(accept);
  let walkRef = (0, import_react35.useRef)(walk);
...
function useWatch(cb, dependencies) {
  let track = (0, import_react36.useRef)([]);
...
var FloatingContext = (0, import_react40.createContext)({
  styles: void 0,
  setReference: () => {
  },
  setFloating: () => {
...
var PlacementContext = (0, import_react40.createContext)(null);
...
function useFloatingReference() {
  return (0, import_react40.useContext)(FloatingContext).setReference;
}
function useFloatingReferenceProps() {
  return (0, import_react40.useContext)(FloatingContext).getReferenceProps;
}
function useFloatingPanelProps() {
  let { getFloatingProps, slot } = (0, import_react40.useContext)(FloatingContext);
...
function useFloatingPanel(placement = null) {
  ...
  let updatePlacementConfig = (0, import_react40.useContext)(PlacementContext);
  let stablePlacement = (0, import_react40.useMemo)(
    () => placement,
    [
      JSON.stringify(
        placement,
  ...
  let context = (0, import_react40.useContext)(FloatingContext);
  return (0, import_react40.useMemo)(
...
function FloatingProvider({
  ...
  let [config, setConfig] = (0, import_react40.useState)(null);
  let [innerOffset, setInnerOffset] = (0, import_react40.useState)(0);
  let overflowRef = (0, import_react40.useRef)(null);
  let [floatingEl, setFloatingElement] = (0, import_react40.useState)(null);
  ...
  if (to === "selection")
    exposedTo = "selection";
  let data = (0, import_react40.useMemo)(
    () => ({
...
function useResolvePxValue(input, element, defaultValue = void 0) {
  ...
  let immediateValue = (0, import_react40.useMemo)(() => computeValue(input, element)[0], [input, element]);
  let [value = immediateValue, setValue] = (0, import_react40.useState)();
  useIsoMorphicEffect(() => {
...
var Context = (0, import_react41.createContext)(null);
Context.displayName = "OpenClosedContext";
function useOpenClosed() {
  return (0, import_react41.useContext)(Context);
}
function OpenClosedProvider({ value, children }) {
  return /* @__PURE__ */ import_react41.default.createElement(Context.Provider, { value }, children);
}
...
var ForcePortalRootContext = (0, import_react43.createContext)(false);
function usePortalRoot() {
  return (0, import_react43.useContext)(ForcePortalRootContext);
}
function ForcePortalRoot(props) {
  return /* @__PURE__ */ import_react43.default.createElement(ForcePortalRootContext.Provider, { value: props.force }, props.children);
}

// src/components/portal/portal.tsx
function usePortalTarget(ref) {
  let forceInRoot = usePortalRoot();
  let groupTarget = (0, import_react44.useContext)(PortalGroupContext);
  let ownerDocument = useOwnerDocument(ref);
  let [target, setTarget] = (0, import_react44.useState)(() => {
    var _a2;
...
var DEFAULT_PORTAL_TAG = import_react44.Fragment;
var InternalPortalFn = forwardRefWithAs(function InternalPortalFn2(props, ref) {
  let theirProps = props;
  let internalPortalRootRef = (0, import_react44.useRef)(null);
...
function PortalFn(props, ref) {
  ...
  return enabled ? /* @__PURE__ */ import_react44.default.createElement(InternalPortalFn, { ...theirProps, ref: portalRef }) : render({
...
var DEFAULT_GROUP_TAG = import_react44.Fragment;
var PortalGroupContext = (0, import_react44.createContext)(null);
function GroupFn(props, ref) {
  let { target, ...theirProps } = props;
  let groupRef = useSyncRefs(ref);
  let ourProps = { ref: groupRef };
  return /* @__PURE__ */ import_react44.default.createElement(PortalGroupContext.Provider, { value: target }, render({
    ourProps,
    theirProps,
...
var PortalParentContext = (0, import_react44.createContext)(null);
function useNestedPortals() {
  let parent = (0, import_react44.useContext)(PortalParentContext);
  let portals = (0, import_react44.useRef)([]);
  ...
  let api = (0, import_react44.useMemo)(
  ...
  return [
    ...
    (0, import_react44.useMemo)(() => {
      return function PortalWrapper({ children }) {
        return /* @__PURE__ */ import_react44.default.createElement(PortalParentContext.Provider, { value: api }, children);
      };
    }, [api])
  ];
}
...
var reducers = {
  ...
  [6 /* UpdateVirtualConfiguration */]: (state, action) => {
    var _a2, _b;
...
var ComboboxActionsContext = (0, import_react45.createContext)(null);
ComboboxActionsContext.displayName = "ComboboxActionsContext";
function useActions(component) {
  let context = (0, import_react45.useContext)(ComboboxActionsContext);
  if (context === null) {
...
var VirtualContext = (0, import_react45.createContext)(null);
function VirtualProvider(props) {
  let data = useData("VirtualProvider");
  let { options } = data.virtual;
  let [paddingStart, paddingEnd] = (0, import_react45.useMemo)(() => {
  ...
  let [baseKey, setBaseKey] = (0, import_react45.useState)(0);
  useIsoMorphicEffect(() => {
    setBaseKey((v) => v + 1);
  }, [options]);
  ...
  return /* @__PURE__ */ import_react45.default.createElement(VirtualContext.Provider, { value: virtualizer }, /* @__PURE__ */ import_react45.default.createElement(
    "div",
    {
      style: {
        position: "relative",
    ...
    items.map((item) => {
      var _a2;
      return /* @__PURE__ */ import_react45.default.createElement(import_react45.Fragment, { key: item.key }, import_react45.default.cloneElement(
...
var ComboboxDataContext = (0, import_react45.createContext)(null);
ComboboxDataContext.displayName = "ComboboxDataContext";
function useData(component) {
  let context = (0, import_react45.useContext)(ComboboxDataContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Combobox /> component.`);
    if (Error.captureStackTrace)
...
var DEFAULT_COMBOBOX_TAG = import_react45.Fragment;
function ComboboxFn(props, ref) {
  ...
  let [state, dispatch] = (0, import_react45.useReducer)(stateReducer, {
    dataRef: (0, import_react45.createRef)(),
  ...
  let defaultToFirstOption = (0, import_react45.useRef)(false);
  let optionsPropsRef = (0, import_react45.useRef)({ static: false, hold: false });
  let inputRef = (0, import_react45.useRef)(null);
  let buttonRef = (0, import_react45.useRef)(null);
  let optionsRef = (0, import_react45.useRef)(null);
  ...
  let isSelected = (0, import_react45.useCallback)(
  ...
  let data = (0, import_react45.useMemo)(
    () => ({
      ...state,
      immediate,
      optionsPropsRef,
  ...
  useIsoMorphicEffect(() => {
    ...
    if (!virtual)
      return;
    dispatch({
      type: 6 /* UpdateVirtualConfiguration */,
  ...
  let actions = (0, import_react45.useMemo)(
    () => ({
      onChange,
      registerOption,
      goToOption,
  ...
  let reset = (0, import_react45.useCallback)(() => {
  ...
  return /* @__PURE__ */ import_react45.default.createElement(
    ...
    /* @__PURE__ */ import_react45.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react45.default.createElement(ComboboxActionsContext.Provider, { value: actions }, /* @__PURE__ */ import_react45.default.createElement(ComboboxDataContext.Provider, { value: data }, /* @__PURE__ */ import_react45.default.createElement(
      OpenClosedProvider,
      {
      ...
      name != null && /* @__PURE__ */ import_react45.default.createElement(
        FormFields,
        {
          disabled,
...
function InputFn(props, ref) {
  ...
  let isTyping = (0, import_react45.useRef)(false);
  let d = useDisposables();
  let clear = useEvent(() => {
  ...
  let currentDisplayValue = (0, import_react45.useMemo)(() => {
    var _a3;
  ...
  let isComposing = (0, import_react45.useRef)(false);
...
function OptionsFn(props, ref) {
  ...
  if (data.virtual && visible) {
    Object.assign(theirProps, {
      ...
      children: /* @__PURE__ */ import_react45.default.createElement(VirtualProvider, null, theirProps.children)
    });
  }
  let [frozenValue, setFrozenValue] = (0, import_react45.useState)(data.value);
  ...
  return /* @__PURE__ */ import_react45.default.createElement(Portal, { enabled: portal ? props.static || visible : false }, /* @__PURE__ */ import_react45.default.createElement(
...
function OptionFn(props, ref) {
  ...
  let internalOptionRef = (0, import_react45.useRef)(null);
  ...
  let virtualizer = (0, import_react45.useContext)(VirtualContext);
  ...
  let enableScrollIntoView = (0, import_react45.useRef)(data.virtual || data.__demoMode ? false : true);
  useIsoMorphicEffect(() => {
    if (data.virtual)
      return;
    if (data.__demoMode)
...
var DEFAULT_DATA_INTERACTIVE_TAG = import_react46.Fragment;
...
function useIsTouchDevice() {
  var _a2;
  let [mq] = (0, import_react47.useState)(
    () => typeof window !== "undefined" && typeof window.matchMedia === "function" ? window.matchMedia("(pointer: coarse)") : null
  );
  let [isTouchDevice, setIsTouchDevice] = (0, import_react47.useState)((_a2 = mq == null ? void 0 : mq.matches) != null ? _a2 : false);
  useIsoMorphicEffect(() => {
    if (!mq)
      return;
...
function useRootContainers({
  ...
  var _a2;
  let mainTreeNodeRef = (0, import_react48.useRef)((_a2 = _mainTreeNodeRef == null ? void 0 : _mainTreeNodeRef.current) != null ? _a2 : null);
  ...
  return {
    ...
    mainTreeNodeRef,
    MainTreeNode: (0, import_react48.useMemo)(() => {
      return function MainTreeNode() {
        if (_mainTreeNodeRef != null)
          return null;
        return /* @__PURE__ */ import_react48.default.createElement(Hidden, { features: 4 /* Hidden */, ref: mainTreeNodeRef });
      };
    }, [mainTreeNodeRef, _mainTreeNodeRef])
  };
}
function useMainTreeNode() {
  let mainTreeNodeRef = (0, import_react48.useRef)(null);
  return {
    mainTreeNodeRef,
    MainTreeNode: (0, import_react48.useMemo)(() => {
      return function MainTreeNode() {
...
var StackContext = (0, import_react49.createContext)(() => {
});
StackContext.displayName = "StackContext";
function useStackContext() {
  return (0, import_react49.useContext)(StackContext);
}
function StackProvider({
  ...
  return /* @__PURE__ */ import_react49.default.createElement(StackContext.Provider, { value: notify }, children);
}
...
function useIsMounted() {
  let mounted = (0, import_react50.useRef)(false);
  useIsoMorphicEffect(() => {
...
function useTabDirection() {
  let direction = (0, import_react51.useRef)(0 /* Forwards */);
  useWindowEvent(
    "keydown",
    (event) => {
      if (event.key === "Tab") {
...
function FocusTrapFn(props, ref) {
  let container = (0, import_react52.useRef)(null);
  ...
  let d = useDisposables();
  let recentlyUsedTabKey = (0, import_react52.useRef)(false);
  let ourProps = {
    ref: focusTrapRef,
    onKeyDown(e) {
      if (e.key == "Tab") {
  ...
  return /* @__PURE__ */ import_react52.default.createElement(import_react52.default.Fragment, null, Boolean(features & 4 /* TabLock */) && /* @__PURE__ */ import_react52.default.createElement(
    Hidden,
    {
      as: "button",
      type: "button",
    ...
    name: "FocusTrap"
  }), Boolean(features & 4 /* TabLock */) && /* @__PURE__ */ import_react52.default.createElement(
    Hidden,
    {
      as: "button",
      type: "button",
...
function useRestoreElement(enabled = true) {
  let localHistory = (0, import_react52.useRef)(history.slice());
  useWatch(
...
function useInitialFocus({
  ...
  let previousActiveElement = (0, import_react52.useRef)(null);
...
var DialogContext = (0, import_react53.createContext)(null);
DialogContext.displayName = "DialogContext";
function useDialogContext(component) {
  let context = (0, import_react53.useContext)(DialogContext);
  if (context === null) {
...
function DialogFn(props, ref) {
  ...
  let [nestedDialogCount, setNestedDialogCount] = (0, import_react53.useState)(0);
  let didWarnOnRole = (0, import_react53.useRef)(false);
  role = function() {
  ...
  let internalDialogRef = (0, import_react53.useRef)(null);
  ...
  let [state, dispatch] = (0, import_react53.useReducer)(stateReducer2, {
    titleId: null,
    descriptionId: null,
    panelRef: (0, import_react53.createRef)()
  });
  ...
  let hasParentDialog = (0, import_react53.useContext)(DialogContext) !== null;
  ...
  let contextBag = (0, import_react53.useMemo)(
  ...
  return /* @__PURE__ */ import_react53.default.createElement(
    ...
    /* @__PURE__ */ import_react53.default.createElement(ForcePortalRoot, { force: true }, /* @__PURE__ */ import_react53.default.createElement(Portal, null, /* @__PURE__ */ import_react53.default.createElement(DialogContext.Provider, { value: contextBag }, /* @__PURE__ */ import_react53.default.createElement(Portal.Group, { target: internalDialogRef }, /* @__PURE__ */ import_react53.default.createElement(ForcePortalRoot, { force: false }, /* @__PURE__ */ import_react53.default.createElement(DescriptionProvider, { slot, name: "Dialog.Description" }, /* @__PURE__ */ import_react53.default.createElement(PortalWrapper, null, /* @__PURE__ */ import_react53.default.createElement(
      FocusTrap,
      {
        initialFocus,
      ...
      /* @__PURE__ */ import_react53.default.createElement(CloseProvider, { value: close }, render({
        ourProps,
        theirProps,
        slot,
    ...
    /* @__PURE__ */ import_react53.default.createElement(HoistFormFields, null, /* @__PURE__ */ import_react53.default.createElement(MainTreeNode, null))
  );
}
...
var startTransition = (
  ...
  (_a = import_react54.default.startTransition) != null ? _a : function startTransition2(cb) {
    cb();
  }
);
...
var DisclosureContext = (0, import_react55.createContext)(null);
DisclosureContext.displayName = "DisclosureContext";
function useDisclosureContext(component) {
  let context = (0, import_react55.useContext)(DisclosureContext);
  if (context === null) {
...
var DisclosureAPIContext = (0, import_react55.createContext)(null);
DisclosureAPIContext.displayName = "DisclosureAPIContext";
function useDisclosureAPIContext(component) {
  let context = (0, import_react55.useContext)(DisclosureAPIContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Disclosure /> component.`);
    if (Error.captureStackTrace)
...
var DisclosurePanelContext = (0, import_react55.createContext)(null);
DisclosurePanelContext.displayName = "DisclosurePanelContext";
function useDisclosurePanelContext() {
  return (0, import_react55.useContext)(DisclosurePanelContext);
}
function stateReducer3(state, action) {
  return match(action.type, reducers3, state, action);
}
var DEFAULT_DISCLOSURE_TAG = import_react55.Fragment;
function DisclosureFn(props, ref) {
  let { defaultOpen = false, ...theirProps } = props;
  let internalDisclosureRef = (0, import_react55.useRef)(null);
  let disclosureRef = useSyncRefs(
    ...
    optionalRef(
      ...
      props.as === import_react55.Fragment
    )
  );
  let panelRef = (0, import_react55.useRef)(null);
  let buttonRef = (0, import_react55.useRef)(null);
  let reducerBag = (0, import_react55.useReducer)(stateReducer3, {
  ...
  let api = (0, import_react55.useMemo)(() => ({ close }), [close]);
  ...
  return /* @__PURE__ */ import_react55.default.createElement(DisclosureContext.Provider, { value: reducerBag }, /* @__PURE__ */ import_react55.default.createElement(DisclosureAPIContext.Provider, { value: api }, /* @__PURE__ */ import_react55.default.createElement(CloseProvider, { value: close }, /* @__PURE__ */ import_react55.default.createElement(
    OpenClosedProvider,
    {
...
function ButtonFn3(props, ref) {
  ...
  let internalButtonRef = (0, import_react55.useRef)(null);
...
function PanelFn2(props, ref) {
  ...
  return /* @__PURE__ */ import_react55.default.createElement(DisclosurePanelContext.Provider, { value: state.panelId }, render({
    mergeRefs,
    ourProps,
    theirProps,
    slot,
...
function FieldFn(props, ref) {
  let inputId = `headlessui-control-${(0, import_react14.useId)()}`;
  let [labelledby, LabelProvider] = useLabels();
  let [describedBy, DescriptionProvider] = useDescriptions();
  let providedDisabled = useDisabled();
  ...
  return /* @__PURE__ */ import_react56.default.createElement(DisabledProvider, { value: disabled }, /* @__PURE__ */ import_react56.default.createElement(LabelProvider, { value: labelledby }, /* @__PURE__ */ import_react56.default.createElement(DescriptionProvider, { value: describedBy }, /* @__PURE__ */ import_react56.default.createElement(IdProvider, { id: inputId }, render({
    ourProps,
    theirProps: {
      ...theirProps,
      children: /* @__PURE__ */ import_react56.default.createElement(FormFieldsProvider, null, typeof theirProps.children === "function" ? theirProps.children(slot) : theirProps.children)
    },
    slot,
...
function useResolvedTag(tag) {
  ...
  let [resolvedTag, setResolvedTag] = (0, import_react57.useState)(tagName);
  return [
...
function FieldsetFn(props, ref) {
  ...
  let [labelledBy, LabelProvider] = useLabels();
  let slot = (0, import_react58.useMemo)(() => ({ disabled }), [disabled]);
  ...
  return /* @__PURE__ */ import_react58.default.createElement(DisabledProvider, { value: disabled }, /* @__PURE__ */ import_react58.default.createElement(LabelProvider, null, render({
    ourProps,
    theirProps,
    slot,
...
function LegendFn(props, ref) {
  return /* @__PURE__ */ import_react60.default.createElement(Label, { as: "div", ref, ...props });
}
...
function useComputed(cb, dependencies) {
  let [value, setValue] = (0, import_react61.useState)(cb);
...
function useDidElementMove(element, enabled = true) {
  let elementPosition = (0, import_react62.useRef)({ left: 0, top: 0 });
  useIsoMorphicEffect(() => {
...
function useTextValue(element) {
  let cacheKey = (0, import_react63.useRef)("");
  let cacheValue = (0, import_react63.useRef)("");
  return useEvent(() => {
    let el = element.current;
    if (!el)
      return "";
...
var ListboxActionsContext = (0, import_react64.createContext)(null);
ListboxActionsContext.displayName = "ListboxActionsContext";
function useActions2(component) {
  let context = (0, import_react64.useContext)(ListboxActionsContext);
  if (context === null) {
...
var ListboxDataContext = (0, import_react64.createContext)(null);
ListboxDataContext.displayName = "ListboxDataContext";
function useData2(component) {
  let context = (0, import_react64.useContext)(ListboxDataContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Listbox /> component.`);
    if (Error.captureStackTrace)
...
var DEFAULT_LISTBOX_TAG = import_react64.Fragment;
function ListboxFn(props, ref) {
  ...
  let [state, dispatch] = (0, import_react64.useReducer)(stateReducer4, {
    dataRef: (0, import_react64.createRef)(),
  ...
  let optionsPropsRef = (0, import_react64.useRef)({ static: false, hold: false });
  let buttonRef = (0, import_react64.useRef)(null);
  let optionsRef = (0, import_react64.useRef)(null);
  let listRef = (0, import_react64.useRef)(/* @__PURE__ */ new Map());
  let compare = useByComparator(by);
  let isSelected = (0, import_react64.useCallback)(
  ...
  let data = (0, import_react64.useMemo)(
    () => ({
      ...state,
      value,
      disabled,
  ...
  let actions = (0, import_react64.useMemo)(
    () => ({
      onChange,
      registerOption,
      goToOption,
  ...
  let reset = (0, import_react64.useCallback)(() => {
    if (defaultValue === void 0)
      return;
    return theirOnChange == null ? void 0 : theirOnChange(defaultValue);
  }, [theirOnChange, defaultValue]);
  return /* @__PURE__ */ import_react64.default.createElement(
    ...
    /* @__PURE__ */ import_react64.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react64.default.createElement(ListboxActionsContext.Provider, { value: actions }, /* @__PURE__ */ import_react64.default.createElement(ListboxDataContext.Provider, { value: data }, /* @__PURE__ */ import_react64.default.createElement(
      OpenClosedProvider,
      {
      ...
      name != null && value != null && /* @__PURE__ */ import_react64.default.createElement(
        FormFields,
        {
          disabled,
          data: { [name]: value },
...
var SelectedOptionContext = (0, import_react64.createContext)(false);
...
function OptionsFn2(props, ref) {
  ...
  let initialOption = (0, import_react64.useRef)(null);
  ...
  let [frozenValue, setFrozenValue] = (0, import_react64.useState)(data.value);
  ...
  return /* @__PURE__ */ import_react64.default.createElement(Portal, { enabled: portal ? props.static || visible : false }, /* @__PURE__ */ import_react64.default.createElement(
...
function OptionFn2(props, ref) {
  ...
  let usedInSelectedOption = (0, import_react64.useContext)(SelectedOptionContext) === true;
  ...
  let selected = data.isSelected(value);
  let internalOptionRef = (0, import_react64.useRef)(null);
...
var DEFAULT_SELECTED_OPTION_TAG = import_react64.Fragment;
function SelectedFn(props, ref) {
  ...
  return /* @__PURE__ */ import_react64.default.createElement(SelectedOptionContext.Provider, { value: true }, render({
    ourProps,
    theirProps: {
      ...theirProps,
      children: /* @__PURE__ */ import_react64.default.createElement(import_react64.default.Fragment, null, placeholder && shouldShowPlaceholder ? placeholder : children)
    },
    slot,
...
var MenuContext = (0, import_react65.createContext)(null);
MenuContext.displayName = "MenuContext";
function useMenuContext(component) {
  let context = (0, import_react65.useContext)(MenuContext);
  if (context === null) {
...
var DEFAULT_MENU_TAG = import_react65.Fragment;
function MenuFn(props, ref) {
  let { __demoMode = false, ...theirProps } = props;
  let reducerBag = (0, import_react65.useReducer)(stateReducer5, {
    __demoMode,
    menuState: __demoMode ? 0 /* Open */ : 1 /* Closed */,
    buttonRef: (0, import_react65.createRef)(),
    itemsRef: (0, import_react65.createRef)(),
    items: [],
    searchQuery: "",
    activeItemIndex: null,
    activationTrigger: 1 /* Other */
  ...
  return /* @__PURE__ */ import_react65.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react65.default.createElement(MenuContext.Provider, { value: reducerBag }, /* @__PURE__ */ import_react65.default.createElement(
    OpenClosedProvider,
    {
...
function ItemsFn(props, ref) {
  ...
  return /* @__PURE__ */ import_react65.default.createElement(Portal, { enabled: portal ? props.static || visible : false }, render({
    ourProps,
    theirProps,
    slot,
...
var DEFAULT_ITEM_TAG = import_react65.Fragment;
function ItemFn(props, ref) {
  ...
  let internalItemRef = (0, import_react65.useRef)(null);
  ...
  let bag = (0, import_react65.useRef)({
    disabled,
  ...
  return /* @__PURE__ */ import_react65.default.createElement(LabelProvider, null, /* @__PURE__ */ import_react65.default.createElement(DescriptionProvider, null, render({
    ourProps,
    theirProps,
    slot,
...
function SectionFn(props, ref) {
  ...
  return /* @__PURE__ */ import_react65.default.createElement(LabelProvider, null, render({
    ourProps,
    theirProps,
    slot: {},
...
function usePopoverContext(component) {
  let context = (0, import_react66.useContext)(PopoverContext);
  if (context === null) {
...
var PopoverAPIContext = (0, import_react66.createContext)(null);
PopoverAPIContext.displayName = "PopoverAPIContext";
function usePopoverAPIContext(component) {
  let context = (0, import_react66.useContext)(PopoverAPIContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Popover /> component.`);
    if (Error.captureStackTrace)
...
var PopoverGroupContext = (0, import_react66.createContext)(null);
PopoverGroupContext.displayName = "PopoverGroupContext";
function usePopoverGroupContext() {
  return (0, import_react66.useContext)(PopoverGroupContext);
}
var PopoverPanelContext = (0, import_react66.createContext)(null);
PopoverPanelContext.displayName = "PopoverPanelContext";
function usePopoverPanelContext() {
  return (0, import_react66.useContext)(PopoverPanelContext);
}
...
function PopoverFn(props, ref) {
  var _a2;
  let { __demoMode = false, ...theirProps } = props;
  let internalPopoverRef = (0, import_react66.useRef)(null);
  ...
  let buttons = (0, import_react66.useRef)([]);
  let reducerBag = (0, import_react66.useReducer)(stateReducer6, {
    __demoMode,
    ...
    panel: null,
    panelId: null,
    beforePanelSentinel: (0, import_react66.createRef)(),
    afterPanelSentinel: (0, import_react66.createRef)(),
    afterButtonSentinel: (0, import_react66.createRef)()
  });
  let [
    {
      popoverState,
  ...
  let isPortalled = (0, import_react66.useMemo)(() => {
    if (!button)
      return false;
    if (!panel)
      return false;
  ...
  let registerBag = (0, import_react66.useMemo)(
    () => ({
  ...
  (0, import_react66.useEffect)(() => registerPopover == null ? void 0 : registerPopover(registerBag), [registerPopover, registerBag]);
  let [portals, PortalWrapper] = useNestedPortals();
  ...
  let api = (0, import_react66.useMemo)(
    () => ({ close, isPortalled }),
    [close, isPortalled]
  );
  ...
  return /* @__PURE__ */ import_react66.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react66.default.createElement(PopoverPanelContext.Provider, { value: null }, /* @__PURE__ */ import_react66.default.createElement(PopoverContext.Provider, { value: reducerBag }, /* @__PURE__ */ import_react66.default.createElement(PopoverAPIContext.Provider, { value: api }, /* @__PURE__ */ import_react66.default.createElement(CloseProvider, { value: close }, /* @__PURE__ */ import_react66.default.createElement(
    OpenClosedProvider,
    {
    ...
    /* @__PURE__ */ import_react66.default.createElement(PortalWrapper, null, render({
      ourProps,
      theirProps,
      slot,
      defaultTag: DEFAULT_POPOVER_TAG,
      name: "Popover"
    }), /* @__PURE__ */ import_react66.default.createElement(root.MainTreeNode, null))
  ))))));
}
...
function ButtonFn6(props, ref) {
  ...
  let internalButtonRef = (0, import_react66.useRef)(null);
  let sentinelId = `headlessui-focus-sentinel-${(0, import_react14.useId)()}`;
  let groupContext = usePopoverGroupContext();
  ...
  let [uniqueIdentifier] = (0, import_react66.useState)(() => Symbol());
  ...
  return /* @__PURE__ */ import_react66.default.createElement(import_react66.default.Fragment, null, render({
    ourProps,
    theirProps,
    slot,
    defaultTag: DEFAULT_BUTTON_TAG6,
    name: "Popover.Button"
  }), visible && !isWithinPanel && isPortalled && /* @__PURE__ */ import_react66.default.createElement(
    Hidden,
    {
      id: sentinelId,
...
function PanelFn3(props, ref) {
  ...
  let internalPanelRef = (0, import_react66.useRef)(null);
  let anchor = useResolvedAnchor(rawAnchor);
  let [floatingRef, style] = useFloatingPanel(anchor);
  let getFloatingPanelProps = useFloatingPanelProps();
  if (anchor) {
  ...
  return /* @__PURE__ */ import_react66.default.createElement(PopoverPanelContext.Provider, { value: id }, /* @__PURE__ */ import_react66.default.createElement(PopoverAPIContext.Provider, { value: { close, isPortalled } }, /* @__PURE__ */ import_react66.default.createElement(Portal, { enabled: portal ? props.static || visible : false }, visible && isPortalled && /* @__PURE__ */ import_react66.default.createElement(
    Hidden,
    {
    ...
    visible,
    name: "Popover.Panel"
  }), visible && isPortalled && /* @__PURE__ */ import_react66.default.createElement(
    Hidden,
    {
...
function GroupFn2(props, ref) {
  let internalGroupRef = (0, import_react66.useRef)(null);
  let groupRef = useSyncRefs(internalGroupRef, ref);
  let [popovers, setPopovers] = (0, import_react66.useState)([]);
  ...
  let contextBag = (0, import_react66.useMemo)(
    () => ({
      registerPopover,
      unregisterPopover,
  ...
  let theirProps = props;
  let ourProps = { ref: groupRef };
  return /* @__PURE__ */ import_react66.default.createElement(PopoverGroupContext.Provider, { value: contextBag }, render({
    ourProps,
    theirProps,
    slot,
...
var RadioGroupDataContext = (0, import_react67.createContext)(null);
RadioGroupDataContext.displayName = "RadioGroupDataContext";
function useData3(component) {
  let context = (0, import_react67.useContext)(RadioGroupDataContext);
  if (context === null) {
...
var RadioGroupActionsContext = (0, import_react67.createContext)(null);
RadioGroupActionsContext.displayName = "RadioGroupActionsContext";
function useActions3(component) {
  let context = (0, import_react67.useContext)(RadioGroupActionsContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <RadioGroup /> component.`);
    if (Error.captureStackTrace)
...
function RadioGroupFn(props, ref) {
  ...
  let compare = useByComparator(by);
  let [state, dispatch] = (0, import_react67.useReducer)(stateReducer7, { options: [] });
  let options = state.options;
  let [labelledby, LabelProvider] = useLabels();
  let [describedby, DescriptionProvider] = useDescriptions();
  let internalRadioGroupRef = (0, import_react67.useRef)(null);
  ...
  let firstOption = (0, import_react67.useMemo)(
    () => options.find((option) => {
  ...
  let containsCheckedOption = (0, import_react67.useMemo)(
  ...
  let radioGroupData = (0, import_react67.useMemo)(
    () => ({ value, firstOption, containsCheckedOption, disabled, compare, ...state }),
    [value, firstOption, containsCheckedOption, disabled, compare, state]
  );
  let radioGroupActions = (0, import_react67.useMemo)(
  ...
  let slot = (0, import_react67.useMemo)(() => ({ value }), [value]);
  let reset = (0, import_react67.useCallback)(() => {
    if (defaultValue === void 0)
      return;
    return triggerChange(defaultValue);
  }, [triggerChange, defaultValue]);
  return /* @__PURE__ */ import_react67.default.createElement(DescriptionProvider, { name: "RadioGroup.Description" }, /* @__PURE__ */ import_react67.default.createElement(LabelProvider, { name: "RadioGroup.Label" }, /* @__PURE__ */ import_react67.default.createElement(RadioGroupActionsContext.Provider, { value: radioGroupActions }, /* @__PURE__ */ import_react67.default.createElement(RadioGroupDataContext.Provider, { value: radioGroupData }, name != null && /* @__PURE__ */ import_react67.default.createElement(
    FormFields,
    {
      disabled,
      data: { [name]: value || "on" },
...
function OptionFn3(props, ref) {
  ...
  let internalOptionRef = (0, import_react67.useRef)(null);
  ...
  return /* @__PURE__ */ import_react67.default.createElement(DescriptionProvider, { name: "RadioGroup.Description" }, /* @__PURE__ */ import_react67.default.createElement(LabelProvider, { name: "RadioGroup.Label" }, render({
    ourProps,
    theirProps,
    slot,
...
function RadioFn(props, ref) {
  ...
  let internalRadioRef = (0, import_react67.useRef)(null);
...
var GroupContext = (0, import_react69.createContext)(null);
GroupContext.displayName = "GroupContext";
var DEFAULT_GROUP_TAG3 = import_react69.Fragment;
function GroupFn3(props) {
  var _a2;
  let [switchElement, setSwitchElement] = (0, import_react69.useState)(null);
  let [labelledby, LabelProvider] = useLabels();
  let [describedby, DescriptionProvider] = useDescriptions();
  let context = (0, import_react69.useMemo)(
    () => ({ switch: switchElement, setSwitch: setSwitchElement }),
    [switchElement, setSwitchElement]
  );
  let ourProps = {};
  let theirProps = props;
  return /* @__PURE__ */ import_react69.default.createElement(DescriptionProvider, { name: "Switch.Description", value: describedby }, /* @__PURE__ */ import_react69.default.createElement(
    LabelProvider,
    {
      name: "Switch.Label",
      value: labelledby,
    ...
    /* @__PURE__ */ import_react69.default.createElement(GroupContext.Provider, { value: context }, render({
      ourProps,
      theirProps,
      slot: {},
...
function SwitchFn(props, ref) {
  ...
  let groupContext = (0, import_react69.useContext)(GroupContext);
  let internalSwitchRef = (0, import_react69.useRef)(null);
  ...
  let d = useDisposables();
  let [changing, setChanging] = (0, import_react69.useState)(false);
  let toggle = useEvent(() => {
    setChanging(true);
    onChange == null ? void 0 : onChange(!checked);
    d.nextFrame(() => {
  ...
  let reset = (0, import_react69.useCallback)(() => {
    if (defaultChecked === void 0)
      return;
    return onChange == null ? void 0 : onChange(defaultChecked);
  }, [onChange, defaultChecked]);
  return /* @__PURE__ */ import_react69.default.createElement(import_react69.default.Fragment, null, name != null && /* @__PURE__ */ import_react69.default.createElement(
    FormFields,
    {
      disabled,
      data: { [name]: value || "on" },
...
function FocusSentinel({ onFocus }) {
  let [enabled, setEnabled] = (0, import_react70.useState)(true);
  let mounted = useIsMounted();
  if (!enabled)
    return null;
...
function useFlags(initialFlags = 0) {
  let [flags, setFlags] = (0, import_react73.useState)(initialFlags);
  let mounted = useIsMounted();
  let addFlag = (0, import_react73.useCallback)(
    (flag) => {
      if (!mounted.current)
        return;
  ...
  let hasFlag = (0, import_react73.useCallback)((flag) => Boolean(flags & flag), [flags]);
  let removeFlag = (0, import_react73.useCallback)(
    (flag) => {
      if (!mounted.current)
        return;
      setFlags((flags2) => flags2 & ~flag);
  ...
  let toggleFlag = (0, import_react73.useCallback)(
    (flag) => {
      if (!mounted.current)
        return;
      setFlags((flags2) => flags2 ^ flag);
...
function useTransition({ container, direction, classes, onStart, onStop }) {
  let mounted = useIsMounted();
  let d = useDisposables();
  let inFlight = (0, import_react74.useRef)(false);
  useIsoMorphicEffect(() => {
    if (direction === "idle")
      return;
    if (!mounted.current)
...
function shouldForwardRef(props) {
  ...
  return (
    ...
    ((_a2 = props.as) != null ? _a2 : DEFAULT_TRANSITION_CHILD_TAG) !== import_react75.Fragment || // If we have a single child, then we can forward the ref directly
    import_react75.default.Children.count(props.children) === 1
  );
}
var TransitionContext = (0, import_react75.createContext)(null);
TransitionContext.displayName = "TransitionContext";
function useTransitionContext() {
  let context = (0, import_react75.useContext)(TransitionContext);
  if (context === null) {
    throw new Error(
...
function useParentNesting() {
  let context = (0, import_react75.useContext)(NestingContext);
  if (context === null) {
    throw new Error(
      "A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />."
    );
...
var NestingContext = (0, import_react75.createContext)(null);
...
function useNesting(done, parent) {
  ...
  let transitionableChildren = (0, import_react75.useRef)([]);
  let mounted = useIsMounted();
  let d = useDisposables();
  ...
  let todos = (0, import_react75.useRef)([]);
  let wait = (0, import_react75.useRef)(Promise.resolve());
  let chains = (0, import_react75.useRef)({
    enter: [],
    leave: [],
    idle: []
  });
...
var DEFAULT_TRANSITION_CHILD_TAG = import_react75.Fragment;
...
function TransitionChildFn(props, ref) {
  ...
  let container = (0, import_react75.useRef)(null);
  ...
  let [state, setState] = (0, import_react75.useState)(show ? "visible" /* Visible */ : "hidden" /* Hidden */);
  ...
  let isTransitioning = (0, import_react75.useRef)(false);
  ...
  return /* @__PURE__ */ import_react75.default.createElement(NestingContext.Provider, { value: nesting }, /* @__PURE__ */ import_react75.default.createElement(
    OpenClosedProvider,
    {
      value: match(state, {
...
function TransitionRootFn(props, ref) {
  ...
  let internalTransitionRef = (0, import_react75.useRef)(null);
  let requiresRef = shouldForwardRef(props);
  ...
  let [initial, setInitial] = (0, import_react75.useState)(true);
  let changes = (0, import_react75.useRef)([show]);
  useIsoMorphicEffect(() => {
    if (initial === false) {
      return;
    }
  ...
  let transitionBag = (0, import_react75.useMemo)(
    () => ({ show, appear, initial }),
    [show, appear, initial]
  );
  ...
  return /* @__PURE__ */ import_react75.default.createElement(NestingContext.Provider, { value: nestingBag }, /* @__PURE__ */ import_react75.default.createElement(TransitionContext.Provider, { value: transitionBag }, render({
    ourProps: {
      ...sharedProps,
      as: import_react75.Fragment,
      children: /* @__PURE__ */ import_react75.default.createElement(
    ...
    theirProps: {},
    defaultTag: import_react75.Fragment,
    features: TransitionChildRenderFeatures,
    visible: state === "visible" /* Visible */,
    name: "Transition"
  })));
...
function ChildFn(props, ref) {
  let hasTransitionContext = (0, import_react75.useContext)(TransitionContext) !== null;
  let hasOpenClosedContext = useOpenClosed() !== null;
  return /* @__PURE__ */ import_react75.default.createElement(import_react75.default.Fragment, null, !hasTransitionContext && hasOpenClosedContext ? (
    // @ts-expect-error This is an object
    /* @__PURE__ */ import_react75.default.createElement(TransitionRoot, { ref, ...props })
  ) : (
    // @ts-expect-error This is an object
    /* @__PURE__ */ import_react75.default.createElement(InternalTransitionChild, { ref, ...props })
  ));
}
