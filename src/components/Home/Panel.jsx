  ...
  return (
    <React.Fragment>
      <div className="flex flex-row justify-center  items-center mb-10 ">
        <button className="font-bold bg-black text-slate-300 px-6 py-4 text-xl tracking-wider hover:bg-slate-300 hover:text-black rounded-lg but_pan h-20 w-40 sm:h-14 sm:w-60">
          Health Status
        </button>
